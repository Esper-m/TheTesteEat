(() => {
    ...
    (() => {
        ...
        const picker = datepicker_min("[data-datepicker]", {
            ...
            customMonths: [ "Jan", "Feb", "Mar", "Apr", "May", "June", "July", "Aug", "Sept", "Oct", "Now", "Dec" ],
            overlayButton: "Ok",
            startDay: 7,
        ...
        function initSliders() {
            if (document.querySelector(".testimonial-block__slider")) new core(".testimonial-block__slider", {
                ...
                speed: 800,
                pagination: {
                    el: ".testimonial-block__pagination",
                    clickable: true
                },
                on: {}
            });
